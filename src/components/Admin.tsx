...
import { Package, ShoppingCart, Plus, Edit2, Trash2, ExternalLink, Loader2, Lock, Key } from 'lucide-react';
...
export function Admin() {
  ...
  // Verifica se já fez login antes (para não pedir senha no refresh)
  useEffect(() => {
      ...
      <div className="min-h-screen bg-black flex items-center justify-center p-4">
        <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-lg w-full max-w-md">
          <div className="flex justify-center mb-6">
            <div className="bg-gradient-to-r from-yellow-600 to-amber-500 p-4 rounded-full">
              <Lock className="w-8 h-8 text-black" />
            </div>
          </div>
          <h2 className="text-2xl font-bold text-center mb-2 text-white">Área Restrita</h2>
          <p className="text-zinc-400 text-center mb-6">Digite a senha de administrador para continuar.</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded py-2 pl-10 pr-4 text-white focus:outline-none focus:border-amber-500 transition-colors"
                  placeholder="••••••••"
                />
              </div>
            </div>
  ...
  // --- TELA DO ADMIN (Só aparece se isAuthenticated for true) ---
  return (
